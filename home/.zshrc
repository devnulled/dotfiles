...
export SBT_DEBUG_OPTS="-XX:+CMSClassUnloadingEnabled -XX:ReservedCodeCacheSize=512M -XX:MaxPermSize=2024M -Xmx4680M -Xms1024M -d64 -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5004"
